...
(function($) {
	...
	*/
	...
	$("#nav .toggle, #nav .toggle2, #flyout .toggle, #flyout .toggle2").on("click", function(){
		$(this).toggleClass("fa-angle-down fa-times");
	});
	...
	// Owl Slider - popular links
	if(typeof $.fn.owlCarousel !== "undefined"){
		var popCount = $(".pop").length;
		$(".owl-carousel-pop").owlCarousel({
			navElement: "span",
			navText: ['<i class="fa fa-angle-left"></i>','<i class="fa fa-angle-right"></i>'],
			responsive: {
				1600: {
					items: popCount >= 5 ? 5 : popCount,
					nav: popCount > 5 ? true : false
				},
				1360: {
					items: popCount >= 4 ? 4 : popCount,
					nav: popCount > 4 ? true : false
				},
				992: {
					items: popCount >= 3 ? 3 : popCount,
					nav: popCount > 3 ? true : false
				},
				768: {
					items: popCount >= 2 ? 2 : popCount,
					nav: popCount > 2 ? true : false
				},
				1: {
					items: 1,
					nav: popCount > 1 ? true : false
				}
			}
		});
	}
